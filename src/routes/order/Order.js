...
const Order = ({ orderFormValue, cartItems, selectedCurrency, clearCart }) => {
    ...
    useEffect(() => {
        document.title = "Order summary | Elegance Fashion";
    }, []);
    ...
    return (
        <main className="order">
            ...
            <section className="order-success">
                ...
                <p>
                    Your order has been received successfully at Elegance Fashion . We're thrilled that you've chosen us for your fashion needs. Your style journey is about to begin!
                </p>
                <h3> Order Details:</h3>
                ...
                If you have any questions or need assistance, feel free to contact Elegance Fashion support team at support@EleganceFashion99.com or +91 9022 388 185.
                <br />
                <p>  Happy Shopping!
                </p>
                <p>Warm regards, <br />
                    The Elegance Fashion Team</p>
            </section>
